...
def plotly_energy_module(
    ...
    if fig is None:
        fig = go.Figure()
    plot_x = list(range(len(energy_hist.accumulated_energies)))
    fig.add_trace(
        go.Scatter(
            x=plot_x,
            y=energy_hist.accumulated_energies,
            mode="lines+markers",
    ...
    fig.add_trace(
        go.Scatter(
            x=plot_x,
            y=energy_hist.energy_balances,
            mode="lines+markers",
            name="energy balance per step (collected - consumed)",
        ),
        row=1,
        col=1,
    )
    ...
    fig.add_trace(
        go.Scatter(
            x=plot_x,
            y=energy_hist.collected_energies,
            mode="lines+markers",
            name="collected energy per step",
        ),
        row=1,
        col=1,
    )
    ...
    fig.add_trace(
        go.Scatter(
            x=plot_x,
            y=energy_hist.node_consumptions,
            mode="lines+markers",
            name="consumed energy per step",
        ),
        row=1,
        col=1,
    )
